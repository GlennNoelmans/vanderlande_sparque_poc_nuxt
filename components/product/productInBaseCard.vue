...
<template>
    <div class="product-card">
        <NuxtLink :to="'/products-in-base/' + itemSKU" @click="setCurrentProduct()">
        ...
        <p class="product-card__title"><NuxtLink :to="'/products-in-base/' + itemSKU" @click="setCurrentProduct()">{{ description }}</NuxtLink></p>
